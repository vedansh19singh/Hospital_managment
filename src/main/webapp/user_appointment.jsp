...
.backImg {
	background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)),
		url("https://th.bing.com/th/id/OIP.zMONi9l3LVnaby1F564_pQHaEj?pid=ImgDet&rs=1");
	height: 20vh;
	width: 100%;
	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 p-5">
				<img alt="" src="https://www.matherhospital.org/wp-content/uploads/2016/04/prescription-pad.jpg" height="70%" width="100%">
			</div>
